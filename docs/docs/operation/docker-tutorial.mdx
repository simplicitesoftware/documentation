...
<TabItem value="almalinux10" label="AlmaLinux 10">
```shell
podman login https://registry.simplicite.io
```
</TabItem>
<TabItem value="others" label="AlmaLinux 8 or 9 or CentOS 7 or Debian">
```shell
...
<TabItem value="others" label="CentOS 7 or Debian">
```shell
sudo docker-compose up [-d]
```
</TabItem>
...
<TabItem value="others" label="Almalinux 8 or 9 CentOS 7 or Debian">
```shell
sudo docker ps
```
</TabItem>
