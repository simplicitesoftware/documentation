...
<Tabs>
<TabItem value="py" label="CentOS 8+/AlmaLinux/RockyLinux">
...
<TabItem value="js" label="CentOS 7">
...
<TabItem value="java" label="Debian">
...
<Tabs>
<TabItem value="py" label="CentOS 8+/AlmaLinux/RockyLinux/Debian">
