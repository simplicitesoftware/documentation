...
The canonical example is this lesson: [basic CSV->XML Adapter](/documentation/integration/adapters/csv-to-xml)
...
The canonical example is this lesson: [direct CSV->DB Adapter](/documentation/integration/adapters/csv)
