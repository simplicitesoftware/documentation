...
The canonical example is this lesson: [basic CSV->XML Adapter](/docs/documentation/integration/adapters/csv-to-xml)
...
The canonical example is this lesson: [direct CSV->DB Adapter](/docs/documentation/integration/adapters/csv)
