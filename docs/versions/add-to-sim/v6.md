...
Create the version 6.x (current and maintained) minor versions in the SIM database:

```shell
sql "insert into versions values ('6.2', '1970-01-01 00:00:00')"
sql "insert into versions values ('6.3', '1970-01-01 00:00:00')"
```
...
sql "insert into versions values ('6.3l', '1970-01-01 00:00:00')"
```

:::note

Versions 6.0 and 6.1 are now outdated, thus not mentioned here any longer.
...
```shell
#!/bin/bash
for branch in 6.2 6.3
# or for branch in 6.2 6.2-light 6.3 6.3-light
do
	version=$branch
	[ $branch = '6.2-light' -o $branch = '6.3-light' ] && version=${version}l
...
for branch in 6.2 6.3
# or for v in 6.2 6.2-light 6.3 6.3-light
do
	version=${branch/-light/l}
