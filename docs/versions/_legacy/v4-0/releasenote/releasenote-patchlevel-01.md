...
Version 4.0 patchlevel 01 release note
======================================
...
- Improved module diff: image fields compare and unified diff on long string, HTML content, notepad and document fields (server scripts, JS/CSS/HTML resources, ...)<br/>![](img/releasenote-patchlevel-01/module-diff.jpg)
