...
Version 3.2 maintenance 01 release note
=======================================
...
- Improved module diff: image fields compare and unified diff on long string, HTML content, notepad and document fields (server scripts, JS/CSS/HTML resources, ...)<br/>![](img/releasenote-maintenance-01/module-diff.jpg)
