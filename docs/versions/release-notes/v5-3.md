...
### 5.3.72 (UNRELEASED) - maintenance revision {#version-5.3.72}
...
- Backported fix module filtering in case of reset and populateForeignKey
- Backported [from v6.2](v6-2#version-6.2.11) module filtering support on Groups displayed in the "Authorization" step of the "Create Activity" system business process
- Backported [from v6.2](v6-2#version-6.2.11) fix SignaturePad resizing (fromDataURL with ratio=1)
