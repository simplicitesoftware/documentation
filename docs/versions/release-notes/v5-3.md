...
> **Note**: This minor version is the last version 5 minor version of version 5.
> Version 5 is now in its **long term maintenance** period.
> Please consider upgrading to the current version 6.
...
- Added `MailTool.convertImages` to replace in email all HTML inlined images `![](img/v5-3/png;base64,...)` with attachments and `![](img/v5-3/cid:...)`
...
### 5.3.0 (2023-04-24) - initial release <span id="version-5.3.0"></span>
...
### 5.3.45 (2024-08-18) - maintenance revision <span id="version-5.3.45"></span>
...
### 5.3.46 (2024-08-30) - maintenance revision <span id="version-5.3.46"></span>
...
### 5.3.47 (2024-09-09) - maintenance revision <span id="version-5.3.47"></span>
...
### 5.3.48 (2024-09-13) - maintenance revision <span id="version-5.3.48"></span>
...
### 5.3.49 (2024-09-13) - maintenance revision <span id="version-5.3.49"></span>

- Fixed regression on loading of cascade deletion definitions

### 5.3.50 (2024-09-20) - maintenance revision <span id="version-5.3.50"></span>
...
### 5.3.51 (2024-10-07) - maintenance revision <span id="version-5.3.51"></span>
...
### 5.3.52 (2024-10-18) - maintenance revision <span id="version-5.3.52"></span>
...
### 5.3.53 (2024-10-28) - maintenance revision <span id="version-5.3.53"></span>
...
### 5.3.54 (2024-11-04) - maintenance revision <span id="version-5.3.54"></span>
...
### 5.3.55 (2024-11-13) - maintenance revision <span id="version-5.3.55"></span>
...
### 5.3.56 (2024-11-22) - maintenance revision <span id="version-5.3.56"></span>
...
### 5.3.57 (2024-11-28) - maintenance revision <span id="version-5.3.57"></span>
...
### 5.3.60 (2025-01-06) - maintenance revision <span id="version-5.3.60"></span>
...
### 5.3.62 (2025-02-12) - maintenance revision <span id="version-5.3.62"></span>
...
### 5.3.63 (2025-02-20) - maintenance revision <span id="version-5.3.63"></span>
...
### 5.3.64 (2025-03-07) - maintenance revision <span id="version-5.3.64"></span>
...
### 5.3.65 (UNRELEASED) - maintenance revision <span id="version-5.3.65"></span>
