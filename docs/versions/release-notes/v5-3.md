...
### 5.3.65 (2025-03-18) - maintenance revision <span id="version-5.3.65"></span>
...
- Backported fix extend button of UI monotoring

### 5.3.66 (UNDEFINED) - maintenance revision <span id="version-5.3.66"></span>
