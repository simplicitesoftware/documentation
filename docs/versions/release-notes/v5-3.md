...
### 5.3.82 (UNRELEASED) - maintenance revision {#version-5.3.82}
...
- Backported [from v6.3](v6-3#version-6.3.0-beta-RC6) Apply settings of list of values `FORMAT.NUM` on the big-decimal field
