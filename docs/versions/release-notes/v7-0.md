...
:::note
Our `latest` Docker images are built with a JVM 21 since major version 6,
...
Note that this major version 7 images will use a JVM 25 as soon as it is released.
:::
