...
| `.jshint-configuration`     | `.jshint-configuration.xml`     |
...
To keep your existing module linting you need to:

- **Rename** your Checkstyle configuration (e.g. `mv .checkstyle-configuration .checkstyle-configuration.xml`)
- **Rename** your JSHint configuration (e.g. `mv .jshint-configuration .jshint-configuration.json`)
- **Rename** your ESLint configuration (e.g. `mv .eslint-configuration .eslint-configuration.mjs`)
- **Refactor** as Javascript your Stylelint configuration (e.g. `mv .stylelint-configuration .stylelint-configuration.mjs`)
