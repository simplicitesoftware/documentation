...
- The legacy **FullCalendar** version <= 4 has be removed, as is the support for these legacy versions in the standard calendars.
  The standard calendars now use version 5 only. Any custom code written for legacy version <= 4> should be refactored for version 5.
