...
Domains can now be positioned either vertically on the left (as in v6.3) or horizontally above the work area, with sub-items and overflow handled via dropdowns in the top menu.
