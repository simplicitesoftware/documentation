...
The JUnit testing framework has been upgraded from version 4 to version 6.

This change **requires refactoring** on all the _Unit tests_ : in most cases changing the imports or the fully qualified names:
