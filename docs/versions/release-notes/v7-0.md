...
- **Google Map** features have been removed and replaced by **Leaflet** to serve the place maps
...
As annonced in 6.3 release notes, the function callback as (first) parameter are no more supported in Ajax services.
