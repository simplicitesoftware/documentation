...
- Backported [from v6.3](v6-3#other-technical-improvements) new `Tool.before/after` date comparison shorthand methods
...
### 6.2.18 (UNRELEASED) {#version-6.2.18}

- Fixed XML import final `status KO` in case of unknown references after recycling
- Fixed multi-doc fields preview
- Backported [from v6.3](v6-3#other-technical-improvements) additional `MissingOverride` rule in the default Checkstyle ruleset
