...
### 6.2.11 (UNRELEASED) {#version-6.2.11}
...
- Fixed module filtering in case of reset and populateForeignKey
- Added module filtering support on Groups displayed in the "Authorization" step of the "Create Activity" system business process
- Fixed SignaturePad resizing (fromDataURL with ratio=1)
