...
- The **PDFBox** lib v2 has been upgraded to v3 in previous minor version 6.1
  which means you have to refactor any potential direct use of this library.
- The deprecated `PlatformHooks.isMenuEnable` has been removed in minor version 6.1 after being deprecated in minor version 6.0
  See [the previous minor version 6.0 release note](v6-0#core-changes) for refactoring instructions.
