...
- The deprecated `PlatformHooks.isMenuEnabled` has been removed in previous minor version 6.1
  See [the previous minor version 6.1 release note](v6-1#core-changes) for refactoring instructions.
