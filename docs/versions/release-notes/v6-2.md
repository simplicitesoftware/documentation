...
Make sure you upgrade to the [current minor version](v6-3) of major version 6.
...
- with the type hidden to avoid direct access through list or form
...
### 6.2.22 (2026-02-06) - maintenance revision {#version-6.2.22}
...
- Backported [from v6.3](v6-3#version-6.3.2) fix on counter widgets layout issues
- Backported [from v6.3](v6-3#version-6.3.3) fix on datalink synchronization of notepad field with textual rendering
...
### 6.2.25 (2026-04-03) - maintenance revision {#version-6.2.25}
...
- Backported [from v6.3](v6-3#version-6.3.7) fix on `grant.rollbackTransaction`.

### 6.2.26 (2026-04-15) - final maintenance revision {#version-6.2.26}

- Upgraded Java libs.

:::warning

This is the **final** revision for this minor version 6.2, no further maintenance will be done on it.
