...
This legacy minor version of major version 6 is in its **short term maintenance** till **April 15th 2026**.
...
### 6.2.23 (UNRELEASED) - maintenance revision {#version-6.2.23}
...
- Backported [from v6.3](v6-3#version-6.3.4) fix copy cascade of multi-documents field
- Backported [from v6.3](v6-3#version-6.3.4) fix copy cascade of inlined 0,1/1,1 objects
