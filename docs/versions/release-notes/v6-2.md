...
The itext lib usage has been deprecated, no default components relies on it any longer,
it will be removed in next major version v7.
...
### 6.2.20 (UNRELEASED) {#version-6.2.20}
...
- Backported [from v6.3](v6-3#version-6.3.0-beta-RC2) Force a metadata reloading for UI instances with a parent object