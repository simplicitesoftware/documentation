...
:::warning
**Warning**: This release note corresponds to the **next** minor version of major version 6.
It is now in final **ALPHA** stage.
It means it is **not yet suitable for production** nor just for development and testing.
:::
