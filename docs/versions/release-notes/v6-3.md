...
It is now in **Release Candidate** (RC) stage.

It means it is not **yet suitable for production** but should now be used for development and testing
on the projects planned for delivery **after** its release scheduled in January 2026.
...
### 6.3.0-RC6 (UNRELEASED) - release candidate 6 {#version-6.3.0-beta-RC6}
