...
- Robustness of populate of nullable key to detect non-`null` empty values
- Fixed code editor height
- Fixed default name of generated JS resource for an external object (`CLASS` istead of legacy `SCRIPT`)
