...
it is recommended to use `SIMPLICITE_MAIL_SERVICE` instead
...
- Added the possibility to override a system parameter by an environment variable named `SIMPLICITE_<system param name>`
