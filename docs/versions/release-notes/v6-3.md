...
- See [the release note of minor version 6.2](v6-2#deprecations)
...
Git tagging of modules goes hand in hand with "[import specification based on Git tags](v7-0#git-tag-importspec)"
...
This feature is still **experimental** thus not yet enabled by default [see below](v6-3#new-featureflags) to enable it.
...
- Backported [from v7.0](v7-0#git-tag-importspec) git tag import specification
- Backported [from v7-0](v7-0#optional-importspec-version) optional import specification module version
...
- Backported [from v7.0](v7-0#external-objects-http-headers) the possibility to add custom HTTP headers in the response of the external objects.
...
- Backported [from v7.0](v7-0#json-schema-tools-improvements) improvements on the `JSONSchemaTool` JSON schema helper class
...
- Backported [from v7.0](v7-0#custom-build-artifacts) possibility to customize the modules' build artifacts (`pom.xml` and `gradle.*`).
...
- Backported [from v7.0](v7-0#well-known-endpoints) OpenIDConnect/OAuth2 "well known" metadata endpoints.
- Backported [from v7.0](v7-0#custom-build-artifacts) the preservation of the module's `README.md` across Git commits.
- Backported [from v7.0](v7-0#rest-mapped-apis-permalinks) permalink support for the REST mapped APIs.
...
- Backported [from v7.0](v7-0#dedicated-code-editor-object-instances) dedicated object instances for the UI code editor.
...
- Backported [from v7.0](v7-0#module-init-io-service) the new `moduleinit` I/O service.
...
- Backported [from v7.0](v7-0#custom-build-artifacts) changed module's `README.md` content generation.
...
- Backported [from v7.0](v7-0#improved-cloudstoragetool) support for user metadata in cloud storages.
...
- Backported [from v7.0](v7-0#outdated-apache-commons) removal of the `xml-apis` lib (conflicting w/ JVM module).
- Fixed missing `com.simplicite.util.engine.DispositionInterface` in public classes.
- Added Skiplinks

### 6.3.6 (2026-03-12) {#version-6.3.6}

- Backported [from v7.0](v7-0#git-commit-list-ordering) default "topological" ordering of module's Git commits.
- Backported [from v7.0](v7-0#additional-libs-in-the-light-variant) inclusion of the _Docx4j_, _JClouds_ and _Tika_ libs in the "light" variant.
...
- Backported [from v7.0](v7-0#extended-footer) optional footer drop-up panel named `FOOTER_ADDON`.
- Backported [from v7.0](v7-0#uniformized-borrow-and-return-object) `Grant.borrowObject`/`Grant.returnObject` methods
...
- Backported [from v7.0](v7-0#metadata-hooks) `preMetadata` and `postMetadata` hooks.
...
- Backported [from v7.0](v7-0#module-audit-io-service) improvements on modules audit.
...
- Backported [from v7.0](v7-0#single-object-re-indexation) the single object re-indexation action.
- Backported [from v7.0](v7-0#shared-code-publication-methods) the possibility to configure
...
- Backported [from v7.0](v7-0#new-supervision-features) new supervision JMX operations.
- Improved RGAA accessibility
...
- Backported  [from v7.0](v7-0#preferred-format-settings-for-module) preferred format settings for module.
- Backported  [from v7.0](v7-0#legacy-rhino-scripts-check) startup blocking error if legacy Rhino scripts are still present.
- Fixed email regex to allow legit stacked dashes/plus signs.
- Backported [from v7.0](v7-0#sql99-fallback-for-unknown-database-types) fallback to SQL99 for unknown (= unsupported) additional database types.
...
- Backported [from v7.0](v7-0#configurable-openidconnect-logout-mode) configurable mode
...
- Backported [from v7.0](v7-0#password-platform-hooks) the new `generatePassword` and `hashPassword` platform hooks.
- Backported [from v7.0](v7-0#active-sessions-check) the new active sessions check scheduled action,
...
- Upgraded Java and Javascript libs.
- Backported  [from v7.0](v7-0#help-from-json-schemas) JSON schema-derived help for widgets external objects and system parameters.
- Backported [from v7.0](v7-0#accordion-widget) accordion widget.
- Backported [from v7.0](v7-0#time-line-widget) time line widget.
...
- Backported [from v7.0](v7-0#default-public-rights) public rights removal.
