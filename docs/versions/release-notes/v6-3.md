...
- All classes related to legacy grant hooks are now in final deprecation stage. Grant hooks have been deprecated since major version 5 in favor of platform hooks,
  the refactoring of user session level logic to `PlatformHooks` should have already been done. All grant hook related stuff will be removed in next major version 7.
