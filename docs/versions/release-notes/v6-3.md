...
- Added a `PlatformHooks.getEndPointURL()` to override the default URL based on the hostname, for specific inter-nodes communication in a cluster (e.g. Kubernetes).
