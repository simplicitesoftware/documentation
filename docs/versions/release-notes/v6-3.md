...
- Backported [from v7.0](v7-0#extended-footer) optional footer dropup panel named `FOOTER_ADDON`
- Hide the textarea of ​​an HTML field before tinyMCE parses its content
