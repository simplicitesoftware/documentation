...
It is now in **BETA Release Candidate** stage.
...
### 6.3.0-RC1 (2025-12-05) - release candidate {#version-6.3.0-beta-RC1}

- Initial release candidate for minor version 6.3. See above for details.

### 6.3.0-RC2 (UNRELEASED) - release candidate {#version-6.3.0-beta-RC2}
