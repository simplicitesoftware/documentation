...
Then the action create or update the history object:
- with technical fields
- the foreign key to parent object with its referenced key fields
- the selected fields to be historized
