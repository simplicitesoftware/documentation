...
- Backported [from v7.0](v7-0#improved-rest-mapped-api) improvements of the REST mapped APIs.
...
- Backported [from v7.0](v7-0#improved-cloud-storage-tools) support for user metadata in cloud storages.
