...
- the [JavaDoc](https://platform.simplicite.io/6.0/javadoc/)
- the [JSDoc](https://platform.simplicite.io/6.0/jsdoc/)
...
- Added Web Content Accessibility from WCAG 2.1
	...
	- [Documentation](/docs/documentation/ui/wcag)
...
### 6.0.0 (2024-01-31) - initial release <span id="version-6.0.0"></span>

- Initial release for minor version 6.0. See above for details.

### 6.0.1 (2024-02-23) <span id="version-6.0.1"></span>
...
### 6.0.2 (2024-03-01) <span id="version-6.0.2"></span>
...
### 6.0.3 (2024-03-07) <span id="version-6.0.3"></span>

- Uniformized outline styles for focused items
...
### 6.0.4 (2024-03-15) <span id="version-6.0.4"></span>
...
### 6.0.5 (2024-03-21) <span id="version-6.0.5"></span>
...
### 6.0.6 (2024-03-29) <span id="version-6.0.6"></span>
...
### 6.0.7 (2024-04-05) <span id="version-6.0.7"></span>
...
### 6.0.8 (2024-04-17) <span id="version-6.0.8"></span>
...
### 6.0.9 (2024-04-23) <span id="version-6.0.9"></span>
...
### 6.0.10 (2024-05-03) <span id="version-6.0.10"></span>
...
### 6.0.11 (2024-05-17) <span id="version-6.0.11"></span>
...
### 6.0.12 (2024-05-31) <span id="version-6.0.12"></span>
...
### 6.0.13 (2024-06-12) <span id="version-6.0.13"></span>
...
### 6.0.14 (2024-06-24) <span id="version-6.0.14"></span>
...
### 6.0.15 (2024-07-05) <span id="version-6.0.15"></span>
...
### 6.0.16 (2024-07-15) - maintenance revision <span id="version-6.0.16"></span>
...
### 6.0.17 (2024-07-25) - maintenance revision <span id="version-6.0.17"></span>
...
### 6.0.18 (2024-08-18) - maintenance revision <span id="version-6.0.18"></span>
...
### 6.0.19 (2024-08-30) - maintenance revision <span id="version-6.0.19"></span>
...
### 6.0.20 (2024-09-06) - maintenance revision <span id="version-6.0.20"></span>
...
### 6.0.21 (2024-09-13) - maintenance revision <span id="version-6.0.21"></span>
...
- Backported `minimal` value for `USE_HEALTH` system parameter to restrict healcheck to monitoring-only data (no information on JVM, server, OS, ...)
...
### 6.0.22 (2024-09-20) - maintenance revision <span id="version-6.0.22"></span>
...
### 6.0.23 (2024-10-07) - maintenance revision <span id="version-6.0.23"></span>
...
### 6.0.24 (2024-10-18) - maintenance revision <span id="version-6.0.24"></span>
...
### 6.0.25 (2024-10-28) - maintenance revision <span id="version-6.0.25"></span>
...
### 6.0.26 (2024-10-31) - final maintenance revision <span id="version-6.0.26"></span>
