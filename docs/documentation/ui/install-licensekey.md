...
Call a service interface: I/O (preferred) or API to create or update the license key record (see [integration interfaces](/docs/documentation/integration/webservices/io-commandline) for details).
