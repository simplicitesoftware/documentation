...
1) Presentation of the [Theme Editor](/documentation/front/theme) tool, allowing you to customize the themes and styles of you applications, all within Simplicité's solution.
2) Overview of the [complementary tool](/documentation/front/styles) for theming, allowing you to add even more precise customizations to your applications.
3) Guide through the [javascript development](/documentation/front/javascript-dev) in Simplicité, both outside with the *NPM Library* and inside with the *External Objects*.
4) Breakdown of the [Ajax Library](/documentation/front/lib-ajax) that is useful for javascript development as it presents the core functions and methods to navigate and manipulate Simplicité's concepts and objects.
5) An understanding of how to create [Custom UI Components](/documentation/front/ui-component), breaking down the processes and techniques to do so using Simplicité's  *External Objects* and some *Web Development*.
6) An extension of *UI Components* to now make those objects outside of Simplicité, creating [external webpages](/documentation/front/web-page) that communicates with Simplicité's backend and allow for even more customized fronts.
...
* [*Responsive UI (Documentation)*](/documentation/ui/responsive)  
* [*Custom UI disposition (Documentation)*](/documentation/core/disposition-code-examples)  
* [*Core Javascript (Documentation)*](/documentation/core/javascript-code-examples)  
* [*Interface tool `$ui` (Documentation)*](/documentation/core/ui-tools-code-examples)  
* [*Custom Services through External Objects (Documentation)*](/documentation/integration/webservices/custom-services)  
* [*Ajax API (Documentation)*](/documentation/integration/librairies/ajax-api)  
