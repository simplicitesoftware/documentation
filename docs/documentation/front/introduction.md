...
5) An understanding of how to create [Custom UI Components](/docs/documentation/front/ui-component), breaking down the processes and techniques to do so using Simplicité's  *External Objects* and some *Web Development*.
...
* [*External Objects (Tutorial)*](/docs/tutorial/enhancing/external-object.md)  
