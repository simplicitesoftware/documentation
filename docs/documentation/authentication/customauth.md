...
When using an Apache or NGINX webserver as reverse proxy you can configure it to enforce client certificate authentication (see [this document](/documentation/misc/webserver-ssl) for details).
