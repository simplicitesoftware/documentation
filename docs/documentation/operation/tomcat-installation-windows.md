...
If needed refer to the [Linux installation document]/lesson/docs/operation/tomcat-installation-linux for more details.
...
for your target Simplicité platform version and suitable for your version of Windows (see [this document]/docs/compatibility#jvm for JVM compliance details).
