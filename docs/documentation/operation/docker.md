...
A simplified **[tutorial](/documentation/operation/docker-tutorial)** is also available for a **step by step** procedure in the usual case.
...
> its password is `mypassword`. See [this document](/documentation/misc/java-ssl) to learn how to build such a keystore file.
...
See [this document](/documentation/operation/kubernetes).
