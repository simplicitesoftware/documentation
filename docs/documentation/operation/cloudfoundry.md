...
Simplicité&reg; instances can easily be deployed on the CloudFoundry&reg;-based IBM Bluemix PaaS:
...
Get the Simplicité&reg; sandbox template from our GIT repository
...
Create a blank Simplicité&reg; instance using the following command
...
Simplicité&reg; instances can easily be deployed on the Pivotal CloudFoundry&reg; PaaS:
