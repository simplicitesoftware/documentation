...
> see [this document](/documentation/operation/docker#exposed-ports) for more details.
...
> **Warning**: As explained in [this document](/documentation/operation/docker#exposed-ports) the `8080` port is for an **HTTP** enpoint of the reverse proxy
...
See [Auto Setup](/documentation/operation/auto-setup)
