...
- your custom pages that uses the standard UI page framework (please refer to [this document](/documentation/core/externalobject-code-examples) for details on how to develop such custom pages).

Note that you can use in either case the other JavaScript APIs such as:

- The [Ajax API](/documentation/integration/librairies/ajax-api) using the `Simplicite.Application` singleton which is available in all standard pages.
- The [JavaScript UI tools](/documentation/core/ui-tools-code-examples)
